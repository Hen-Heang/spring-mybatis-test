...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .alert-error { background-color: #fee2e2; border: 1px solid #ef4444; color: #dc2626; }
        .alert-success { background-color: #d1fae5; border: 1px solid #10b981; color: #059669; }
